...
public:
  ...
  bool IsConnectedWeight(const N &src, const N &dst, const E &weight);
...
public:
  ...
  public:
    ...
    friend bool operator==(const const_iterator &lhs,
      ...
      return lhs.node_ == rhs.node_ &&
             (lhs.node_ == lhs.endSentinel_ || lhs.edge_ == rhs.edge_);
    }
  ...
  public:
    ...
    const const_reverse_iterator &operator++() {
      ...
      if (edge_ == node_->second->outGoing_.rend()) {
        do {
          ++node_;
        } while (node_ != endSentinel_ && node_->second->outGoing_.rbegin() ==
                                              node_->second->outGoing_.rend());
        if (node_ != endSentinel_) {
    ...
    const_reverse_iterator &operator--() {
      ...
      if (edge_ == node_->second->outGoing_.rbegin()) {
        do {
          --node_;
        } while (node_ != fntSentinel_ && node_->second->outGoing_.rbegin() ==
                                              node_->second->outGoing_.rend());
        if (node_ != fntSentinel_) {
  ...
  private:
    ...
    typename std::map<N, std::shared_ptr<Node>>::const_reverse_iterator
        fntSentinel_;
    typename std::map<N, std::shared_ptr<Node>>::const_reverse_iterator
        endSentinel_;
